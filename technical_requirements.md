...
Если пользователь является Тимлидером, то для него отображаются 3 кнопки — "Удалить сопровождающего из приезда", "Утвердить этот приезд" и "Добавить сопровождающих в этот приезд":
