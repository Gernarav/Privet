...
1. Полное имя
2. Гражданство — информационная панель, открывающаяся поверх текущего экрана с названиями всех стран, их 
...
Тимлидер является таким же пользователем, как и Наставник, имеет тот же функционал, но расширенный. После 
аутентификации получает доступ к своему функционалу в системе. Этот функционал состоит из следующих экранов:
...